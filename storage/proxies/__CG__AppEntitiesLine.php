 ...
 */
class Line extends \App\Entities\Line implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Line' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Line' . "\0" . 'name', '' . "\0" . 'App\\Entities\\Line' . "\0" . 'color', '' . "\0" . 'App\\Entities\\Line' . "\0" . 'company', '' . "\0" . 'App\\Entities\\Line' . "\0" . 'occurrences'];
        }
    ...
    public function getLastOccurrence()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLastOccurrence', []);

        return parent::getLastOccurrence();
    }
