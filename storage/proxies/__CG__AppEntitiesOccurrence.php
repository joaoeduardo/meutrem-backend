...
class Occurrence extends \App\Entities\Occurrence implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Occurrence' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Occurrence' . "\0" . 'description', '' . "\0" . 'App\\Entities\\Occurrence' . "\0" . 'status', '' . "\0" . 'App\\Entities\\Occurrence' . "\0" . 'line', '' . "\0" . 'App\\Entities\\Occurrence' . "\0" . 'startedAt', '' . "\0" . 'App\\Entities\\Occurrence' . "\0" . 'finishedAt'];
        }
     ...
     * {@inheritDoc}
     */
    public function setStatus(\App\Entities\Status $status)
    {
     ...
     * {@inheritDoc}
     */
    public function setLine(\App\Entities\Line $line)
    {
