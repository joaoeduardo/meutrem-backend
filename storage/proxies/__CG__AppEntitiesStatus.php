 ...
 */
class Status extends \App\Entities\Status implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Status' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Status' . "\0" . 'name', '' . "\0" . 'App\\Entities\\Status' . "\0" . 'occurrences'];
        }
